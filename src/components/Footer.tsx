...
import { NAV_LINKS, CONTACT_INFO } from "@/constants/nav-links";
import {
  Phone,
  Mail,
  MapPin,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
            ...
            <div className="flex flex-col gap-4 items-center text-center md:items-start md:text-start">
              <Link href="/" className="inline-block">
                <div className="relative w-28 h-16 sm:w-32 sm:h-20 md:w-36 md:h-24 mb-2">
                  <Image
                    src="/logo.png"
                    ...
                    unoptimized
                    className={cn(
                      "object-contain object-center md:object-left rtl:md:object-right",
                      "brightness-0 invert",
                    )}
                  />
                </div>
              ...
              <div className="mt-6 pt-3 border-t border-slate-600 w-full md:w-auto">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium leading-relaxed text-start">
